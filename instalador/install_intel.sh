...
cd $REPORT_HOME_JAVA &&
wget https://cdn.azul.com/zulu/bin/zulu17.42.19-ca-jdk17.0.7-macosx_x64.zip &&
unzip zulu17.42.19-ca-jdk17.0.7-macosx_x64.zip &&
mv zulu17.42.19-ca-jdk17.0.7-macosx_x64 zulu17 &&
...
chmod +x ReporteNetsuiteApp.app &&
cp -R ReporteNetsuiteApp.app /Applications &&
